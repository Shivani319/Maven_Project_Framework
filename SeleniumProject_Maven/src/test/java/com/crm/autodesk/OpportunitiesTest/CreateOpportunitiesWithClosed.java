...
public class CreateOpportunitiesWithClosed extends BaseClass {
	@Test
	public void createOpportunitiesWithClosedTest() throws Throwable {
		// navigate to opportunities page
				String oppName = exlib.getExcelData("sheet1", 11, 2);
				String salesType = exlib.getExcelData("Sheet1", 11, 4);
